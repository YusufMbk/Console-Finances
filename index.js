...
for(let index = 0; index < netArray.length; index++){
    netChangeInSum = netChangeInSum + netArray[index];

}

average = Math.round((netChangeInSum / 86)*100) / 100
...
'Greatest Increase in profit: ' + max + '\n' +
'Greatest Decrease in profit: ' + min + '\n' 
